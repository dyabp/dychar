...
namespace DyCompanyName.DyProjectName.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update DyProjectNameDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update DyProjectNameEfCoreEntityExtensionMappings to extend the IdentityUser entity
